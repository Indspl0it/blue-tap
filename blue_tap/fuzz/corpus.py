...
class Corpus:
    ...
    def generate_builtin_seeds(self, protocol: str) -> list[bytes]:
        ...
        ``blue_tap.fuzz.protocols.*``.  This method is a convenience wrapper
...
_PROTOCOL_GENERATORS: dict[str, tuple[str, str, str | None]] = {
    ...
    "sdp":          ("blue_tap.fuzz.protocols.sdp",         "generate_all_sdp_fuzz_cases",    None),
    "obex-pbap":    ("blue_tap.fuzz.protocols.obex",        "generate_all_obex_fuzz_cases",   "pbap"),
    "obex-map":     ("blue_tap.fuzz.protocols.obex",        "generate_all_obex_fuzz_cases",   "map"),
    "obex-opp":     ("blue_tap.fuzz.protocols.obex",        "generate_all_obex_fuzz_cases",   "opp"),
    "at-hfp":       ("blue_tap.fuzz.protocols.at_commands",  "ATCorpus.generate_hfp_slc_corpus", None),
    "at-phonebook": ("blue_tap.fuzz.protocols.at_commands",  "ATCorpus.generate_phonebook_corpus", None),
    "at-sms":       ("blue_tap.fuzz.protocols.at_commands",  "ATCorpus.generate_sms_corpus",  None),
    "at-injection": ("blue_tap.fuzz.protocols.at_commands",  "ATCorpus.generate_injection_corpus", None),
    "ble-att":      ("blue_tap.fuzz.protocols.att",         "generate_all_att_fuzz_cases",    None),
    "ble-smp":      ("blue_tap.fuzz.protocols.smp",         "generate_all_smp_fuzz_cases",    None),
