...
def _build_protocol_registry() -> dict[str, Callable[[], list]]:
    ...
    """
    from blue_tap.modules.fuzzing.protocols.sdp import generate_all_sdp_fuzz_cases
    ...
    from blue_tap.modules.fuzzing.protocols.att import generate_all_att_fuzz_cases
    from blue_tap.modules.fuzzing.protocols.smp import generate_all_smp_fuzz_cases
    from blue_tap.modules.fuzzing.protocols.bnep import generate_all_bnep_fuzz_cases
    from blue_tap.modules.fuzzing.protocols.rfcomm import generate_all_rfcomm_fuzz_cases
    from blue_tap.modules.fuzzing.protocols.l2cap import generate_all_l2cap_fuzz_cases
    from blue_tap.modules.fuzzing.protocols.l2cap_raw import generate_all_l2cap_sig_fuzz_cases
    from blue_tap.modules.fuzzing.protocols.lmp import generate_all_lmp_fuzz_cases
    ...
    return {
        ...
        "l2cap-sig": generate_all_l2cap_sig_fuzz_cases,
        "lmp": _lmp_bytes_only,
    }
