...
class OBEXStateMachine(StateMachineModel):
    ...
    def __init__(self, profile: str = "pbap") -> None:
        from blue_tap.modules.fuzzing.protocols.obex import (
            OBEX_CONNECT,
            OBEX_CONTINUE,
            OBEX_DISCONNECT,
            OBEX_GET_FINAL,
...
class HFPStateMachine(StateMachineModel):
    ...
    def __init__(self) -> None:
        from blue_tap.modules.fuzzing.protocols.at_commands import at_cmd
...
class LMPStateMachine(StateMachineModel):
    ...
    def __init__(self) -> None:
        from blue_tap.modules.fuzzing.protocols.lmp import (
            build_features_req,
            build_features_res,
            build_version_req,
            build_au_rand,
