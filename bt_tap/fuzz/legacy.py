"""Legacy fuzzer classes — migrated from bt_tap/attack/fuzz.py.

These classes provide the original L2CAP, RFCOMM, and SDP fuzzing
primitives from BT-Tap v1.x.  They remain fully functional but are
superseded by the protocol-aware campaign engine in bt_tap.fuzz.engine.

For new fuzzing work, prefer ``bt-tap fuzz campaign`` which supports
...
_DEPRECATION_MSG = (
    ...
    "Use 'bt-tap fuzz campaign' for protocol-aware fuzzing with crash "
